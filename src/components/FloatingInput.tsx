    ...
    <div className="relative w-full mb-6 group">
      <div className="relative">
        ...
        <input
          ...
          className={`peer block w-full ${Icon ? 'pl-9' : 'pl-3'} ${rightElement ? 'pr-9' : 'pr-3'} h-14 bg-[#fffef9] border border-[#e8e0d0] rounded-xl text-base text-brand-dark focus:ring-2 focus:ring-[#C9973A]/20 focus:border-[#C9973A] outline-none transition-all font-medium ${className}`}
        />
        <label
