...
const PROCESS_OPTIONS: ProcessOption[] = [
  {
    ...
    icon: Zap,
    description:
      'Fast-track your inquiry. Receive a quotation and pay directly via your virtual account.',
  ...
  },
  {
    ...
    icon: ClipboardList,
    description:
      'Full procurement workflow with purchase orders, confirmations, delivery tracking, and invoicing.',
    steps: [
      'Inquiry',
      'Quotation',
      'Purchase Order',
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        {PROCESS_OPTIONS.map((option) => {
          ...
          return (
            <motion.button
              ...
              className={`relative p-8 rounded-4xl border-2 text-left transition-all flex flex-col h-full ${
                isSelected
      ...
      <div className="flex flex-col sm:flex-row items-center justify-end gap-4">
        <Button variant="outline" onClick={onBack} className="w-full sm:w-auto px-8">
          Cancel
        </Button>
        <Button
