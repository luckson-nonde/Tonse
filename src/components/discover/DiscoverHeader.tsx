...
export default function DiscoverHeader({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#fffaf5]/90 backdrop-blur-md border-b border-[#e7e0d5]">
      <div className="px-5 sm:px-8 lg:px-12 py-3.5 flex items-center gap-6">
        {onBack && (
          <button
            onClick={onBack}
        ...
        {user ? (
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="rounded-full bg-[#1B3068] text-white font-semibold text-sm px-5 py-2.5 hover:bg-[#142550] transition-colors"
            >
              Dashboard
            </button>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-full border border-[#e7e0d5] text-[#1B3068] font-semibold text-sm px-5 py-2.5 hover:border-[#1B3068] transition-colors"
            >
              Log in
            </button>
            <button
              onClick={() => navigate('/register')}
              className="rounded-full bg-[#c9973a] text-white font-semibold text-sm px-5 py-2.5 hover:bg-[#a97c27] transition-colors"
            >
              Get started
            </button>
          </div>
