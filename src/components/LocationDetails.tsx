...
const ZAMBIA_DATA: Record<string, string[]> = {
  ...
  "Copperbelt": ["Ndola", "Kitwe", "Chingola", "Mufulira", "Luanshya", "Kalulushi", "Chililabombwe", "Mpongwe", "Lufwanyama", "Masilémbo"],
  "Eastern": ["Chipata", "Petauke", "Lundazi", "Katete", "Nyimba", "Sinda", "Chadiza", "Vubwi", "Mambwe", "Chasefu", "Lumezi", "Kasenengwa"],
  "Luapula": ["Mansa", "Nchelenge", "Kawambwa", "Samfya", "Mwense", "Chembe", "Chiengi", "Lunga", "Milenge", "Mwansabombwe", "Chifunabuli"],
  "Lusaka": ["Lusaka", "Kafue", "Chongwe", "Rufunsa", "Chilanga", "Luangwa", "Chirundu"],
  "Muchinga": ["Chinsali", "Mpika", "Nakonde", "Isoka", "Mafinga", "Shiwa Ng'andu", "Kanchibiya", "Lavushimanda"],
  "Northern": ["Kasama", "Mbala", "Mporokoso", "Luwingu", "Mungwi", "Kaputa", "Senga Hill", "Lunte", "Nsama"],
  "North-Western": ["Solwezi", "Mwinilunga", "Zambezi", "Kabompo", "Mufumbwe", "Chavuma", "Kasempa", "Ikelenge", "Manyinga", "Mushindamo", "Kalumbila"],
  "Southern": ["Livingstone", "Choma", "Mazabuka", "Monze", "Kalomo", "Namwala", "Pemba", "Zimba", "Sinazongwe", "Gwembe", "Kazungula", "Chikankata", "Bweengwa"],
    ...
    <div className="max-w-[480px] mx-auto w-full bg-[#f5f2ed] min-h-screen">
      ...
      <div className="p-[20px_16px_140px_16px] flex flex-col gap-6">
        ...
        <div className="relative">
          {useGps ? (
            <div className="bg-white rounded-[24px] p-6 shadow-sm border border-[#f1f5f9] space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* GPS Visualizer */}
              <div className="flex flex-col items-center justify-center py-6 relative">
                ...
                <div className="mt-6 text-center">
                  <h3 className="text-[18px] font-bold text-[#1a1a2e] tracking-tight font-sans">GPS Active</h3>
                ...
                <div className="bg-[#f8fafc] rounded-[20px] p-6 border border-[#f1f5f9]">
                  <div className="flex justify-between items-center mb-6">
                    <div>
                      ...
                      <h4 className="text-[13px] font-bold text-[#1a1a2e] mt-1 font-sans">Coverage Area</h4>
                    </div>
                    <div className="text-right">
                      <span className="text-[32px] font-bold text-[#C9973A] tabular-nums font-serif">{radius}</span>
                      <span className="text-[11px] font-bold text-[#94a3b8] ml-1 uppercase font-sans">km</span>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between mt-3 px-1">
                    {[1, 25, 50, 75, 100].map(val => (
                      <span key={val} className="text-[9px] font-bold text-[#94a3b8] font-sans">{val}km</span>
                    ))}
                  </div>
                </div>
              )}
              ...
              >
                <Navigation className={`w-3.5 h-3.5 ${isLocating ? 'animate-spin' : ''} text-[#C9973A]`} />
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex items-center gap-4 mb-2 ml-1">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-wider font-sans">Specify location details</p>
                </div>
              </div>
        ...
        <div className="pt-4 pb-12">
          <button 
            ...
            className="w-full h-[54px] bg-[#C9973A] rounded-[50px] flex items-center justify-center gap-[10px] font-sans text-[15px] font-semibold text-white tracking-[0.02em] shadow-[0_4px_16_rgba(201,151,58,0.35)] disabled:opacity-50 transition-all active:scale-[0.98]"
          >
            {submitLabel}
          </button>
        </div>
