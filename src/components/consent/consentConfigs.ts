...
export const DEFAULT_PRIVACY_BODY =
  'Your information is encrypted, securely stored, and only used for verification, platform security, and legal compliance. Nyuwe never sells your personal information.';

export const DEFAULT_CONSENT_LABEL =
  'I understand why this information is required and consent to the collection, verification, secure storage, and processing of my information in accordance with the Nyuwe Privacy Policy and Terms of Service.';
