  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
        ...
        <StatTile label="Completed Trades" value={funnel.tradesComplete} icon={Handshake} hint="Closed a deal on Tonse" />
      </div>
      ...
      <div className="flex items-start gap-3 p-4 bg-emerald-50 border border-emerald-100 rounded-2xl">
        ...
        <div>
          ...
          <p className="text-[12px] text-emerald-600/80 font-medium">
            Your documents were reviewed and approved by the Tonse team.
          </p>
        </div>
      </div>
    );
    ...
    <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-100 rounded-2xl">
      ...
      <div>
        ...
        <p className="text-[12px] text-amber-600/80 font-medium">
          The Tonse team is reviewing your ID and selfie — you can keep promoting meanwhile.
        </p>
      </div>
    </div>
  );
    ...
    <form onSubmit={save} className="space-y-6">
      ...
      <section className="bg-white border border-slate-100 rounded-2xl p-5 sm:p-6 shadow-[0_4px_18px_-12px_rgba(15,23,42,0.08)]">
        ...
        <p className="text-[11px] text-slate-400 font-medium mb-4">
          The audiences you'll be promoting Tonse to — at least one required.
        </p>
      ...
      <section className="bg-white border border-slate-100 rounded-2xl p-5 sm:p-6 shadow-[0_4px_18px_-12px_rgba(15,23,42,0.08)]">
        ...
        <p className="text-[11px] text-slate-400 font-medium mb-4">
          Reviewed by the Tonse team only — replacing either resubmits you for verification.
        </p>
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
