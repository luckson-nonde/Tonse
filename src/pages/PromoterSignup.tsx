    ...
    <AuthSplitLayout hideHeader>
      <div className="w-full max-w-[480px] mx-auto">
        ...
        <p className="text-[14px] text-slate-500 mt-2 mb-6">
          {step === 1
            ? 'Get your personal referral link, track every person you bring to Tonse, and earn equity shares as they trade.'
        ...
        {step === 1 ? (
          <form className="w-full" onSubmit={continueToIdentity}>
            ...
            <div className="mb-6">
              ...
              <p className="mt-2 text-[12px] text-slate-400 font-medium">
                The key from your Tonse agreement. This programme is invite-only.
              </p>
            </div>
          ...
          <form className="w-full" onSubmit={handleSubmit}>
            ...
            <p className="mt-4 text-[11px] text-slate-400 font-medium leading-relaxed">
              Your ID and selfie are reviewed by the Tonse team only, to confirm your identity —
