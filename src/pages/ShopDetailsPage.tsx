...
export default function ShopDetailsPage() {
   ...
   */
  const trendingItems = useLiveQuery(
    async () => {
      if (!shop) return [];
  ...
  return (
    <div className="-mx-4 sm:-mx-6 lg:-mx-8 -mt-4 sm:-mt-6 lg:-mt-8 pb-12">
      ...
      <div className="relative h-[220px] overflow-hidden">
        ...
        <button 
          onClick={() => navigate(-1)} 
          className="absolute top-6 left-6 w-[36px] h-[36px] rounded-full bg-white/85 backdrop-blur-md text-[#1e293b] flex items-center justify-center shadow-[0_2px_8px_rgba(0,0,0,0.15)] hover:bg-white transition-all"
        >
        ...
        <div className="bg-white rounded-[32px] p-6 sm:p-8 shadow-xl border border-slate-100">
          <div className="flex flex-col sm:flex-row sm:items-end gap-6 mb-8">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h1 className="text-[26px] font-serif font-bold text-[#1e293b]" style={{ fontFamily: "'Playfair Display', serif" }}>{shop.name}</h1>
              ...
              <div className="flex flex-wrap gap-4 text-sm">
                <div className="flex items-center gap-2 bg-[#fdfaf6] border border-[#e8e0d0] text-slate-700 px-3 py-1.5 rounded-full font-sans font-medium text-[13px]">
                  ...
                  <span className="font-bold text-[#1e293b] ml-1">{shop.rating}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="md:col-span-2 space-y-8">
              {/* About */}
              <section>
                <h3 className="text-[18px] font-serif font-bold text-[#1e293b] mb-3 border-l-[3px] border-[#C9973A] pl-[10px]">About the Shop</h3>
                <p className="text-slate-600 leading-relaxed">{shop.description}</p>
              </section>

              {/* Proof Photos */}
              <section>
                <div className="flex items-center gap-2 mb-4 border-l-[3px] border-[#C9973A] pl-[10px]">
                  <Camera className="w-5 h-5 text-[#64748b]" />
                  <h3 className="text-[18px] font-serif font-bold text-[#1e293b]">Proof Photos</h3>
                </div>
              ...
              <section className="bg-white rounded-[32px] p-6 border border-[#f1f5f9] shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
                <div className="flex items-center justify-between mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-sans font-bold text-[#9ca3af] uppercase tracking-wider">Most requested in {shop.category}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {trendingItems.length > 0 ? (
                    ...
                    <div className="col-span-full py-8 flex flex-col items-center justify-center text-center">
                      ...
                      <p className="text-[13px] text-[#9ca3af] font-sans font-normal">Market data loading...</p>
                    </div>
                  )}
                </div>
              </section>
              ...
              {shop.latitude && shop.longitude && (
                <section>
                  ...
                  <div className="aspect-video rounded-[32px] overflow-hidden border border-slate-100 shadow-sm">
                    <iframe
                      width="100%"
                      height="100%"
                      frameBorder="0"
            ...
            <div className="space-y-8">
              ...
              <section className="bg-slate-50 rounded-3xl p-6 border border-slate-100">
                <h3 className="text-[11px] font-sans font-bold text-[#C9973A] uppercase tracking-wider mb-4">Registration Details</h3>
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-[11px] font-sans font-bold text-[#C9973A] uppercase tracking-wider">Joined Platform</p>
                      <p className="text-sm font-bold text-slate-900">
                        {new Date(shop.registrationDate).toLocaleDateString('en-GB', { day: 'numeric', month: 'long', year: 'numeric' })}
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  {shop.registrationDocuments.map((doc) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-sm font-bold text-slate-700">Registration Document</span>
                      </div>
