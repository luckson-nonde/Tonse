...
export const equipmentRentalCoreSchema: FieldSchema[] = [
  ...
  { name: "deliveryStatus", label: "Delivery Status", type: "select", required: true, options: ["Delivery Required", "Self-Pickup"], group: "Core Details" },
  { name: "deliveryAddress", label: "Delivery Address", type: "text", required: false, placeholder: "Where should equipment be delivered?", group: "Core Details" }
];
...
const buildingMaterialsSchema: FieldSchema[] = [
  ...
  { name: "deliveryRequired", label: "Delivery Required?", type: "toggle", required: false, helpText: "Toggle if you need materials delivered to site", group: "Delivery & Timeline" },
  { name: "deliveryLocation", label: "Delivery Location", type: "text", required: false, placeholder: "e.g. Plot 1234 Meanwood Lusaka", group: "Delivery & Timeline" },
  { name: "budget", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget & Urgency" },
  { name: "urgency", label: "Urgency", type: "select", required: true, options: ["Immediately", "Within a week", "Within a month", "Planning Ahead"], group: "Budget & Urgency" },
...
const freshProduceSchema: FieldSchema[] = [
  ...
  { name: "deliveryRequired", label: "Delivery Required?", type: "toggle", required: false, helpText: "Toggle if you need produce delivered", group: "Order Details" },
  { name: "deliveryLocation", label: "Delivery Location", type: "text", required: false, placeholder: "e.g. Home address, Restaurant name & area", group: "Order Details" },
  { name: "budget", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget & Urgency" },
...
const pantryStaplesSchema: FieldSchema[] = [
  ...
  { name: "deliveryRequired", label: "Delivery Required?", type: "toggle", required: false, group: "Order Details" },
  { name: "deliveryLocation", label: "Delivery Location", type: "text", required: false, placeholder: "e.g. Home address, Business name & area", group: "Order Details" },
  { name: "budget", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget & Urgency" },
  { name: "urgency", label: "When Do You Need It?", type: "select", required: true, options: ["Immediately", "Within a week", "Within a month", "Planning Ahead"], group: "Budget & Urgency" },
...
const beveragesSchema: FieldSchema[] = [
  ...
  { name: "deliveryRequired", label: "Delivery Required?", type: "toggle", required: false, group: "Order Details" },
  { name: "deliveryLocation", label: "Delivery Location", type: "text", required: false, placeholder: "e.g. Home address, Event venue, Shop name", group: "Order Details" },
  { name: "budget", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget & Urgency" },
  { name: "urgency", label: "When Do You Need It?", type: "select", required: true, options: ["Immediately", "Within a week", "Within a month", "Planning Ahead"], group: "Budget & Urgency" },
...
const snacksSweetsSchema: FieldSchema[] = [
  ...
  { name: "orderFrequency", label: "Order Frequency", type: "select", required: true, options: ["One Time Order", "Weekly Supply", "Monthly Supply", "Bulk / Wholesale"], group: "Order Details" },
  { name: "deliveryRequired", label: "Delivery Required?", type: "toggle", required: false, group: "Order Details" },
  { name: "deliveryLocation", label: "Delivery Location", type: "text", required: false, placeholder: "e.g. Home address, Office, Event venue", group: "Order Details" },
  { name: "budget", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget & Urgency" },
  { name: "urgency", label: "When Do You Need It?", type: "select", required: true, options: ["Immediately", "Within a week", "Within a month", "Planning Ahead"], group: "Budget & Urgency" },
