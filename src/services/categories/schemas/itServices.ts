...
export const softwareWebDevSchema: FieldSchema[] = [
  ...
  { name: "preferredDateTime", label: "Preferred Day & Time", type: "datetime", required: true, keepInExpress: true, helpText: "Pick the exact day and time that suits you — the provider plans around it.", group: "Budget and Timeline", dependsOn: { field: "timeline", value: ["Within a week", "Within a month", "Planning Ahead"] } },
