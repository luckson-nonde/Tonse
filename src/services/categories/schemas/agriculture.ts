...
export const poultryFarmingSchema: FieldSchema[] = [
  ...
  { name: "urgency", label: "When do you need it?", type: "select", required: true, options: ["Immediately", "On a specific date & time"], group: "Inquiry Details" },
  { name: "preferredDateTime", label: "Preferred Day & Time", type: "datetime", required: true, keepInExpress: true, helpText: "Pick the day that suits you — add a time only if it needs to happen at a specific hour.", group: "Inquiry Details", dependsOn: { field: "urgency", value: ["On a specific date & time"] } },
...
export const agroTechServicesSchema: FieldSchema[] = [
  ...
  { name: "urgency", label: "When do you need it?", type: "select", required: true, options: ["Immediately", "On a specific date & time"], group: "Service Details" },
  { name: "preferredDateTime", label: "Preferred Day & Time", type: "datetime", required: true, keepInExpress: true, helpText: "Pick the day that suits you — add a time only if it needs to happen at a specific hour.", group: "Service Details", dependsOn: { field: "urgency", value: ["On a specific date & time"] } },
  { name: "budget_limit", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget and Preferences" },
