...
export const poultryFarmingSchema: FieldSchema[] = [
  ...
  { name: "preferredDateTime", label: "Preferred Day & Time", type: "datetime", required: true, keepInExpress: true, helpText: "Pick the exact day and time that suits you — the provider plans around it.", group: "Inquiry Details", dependsOn: { field: "urgency", value: ["On a specific date & time"] } },
...
export const agroTechServicesSchema: FieldSchema[] = [
  ...
  { name: "preferredDateTime", label: "Preferred Day & Time", type: "datetime", required: true, keepInExpress: true, helpText: "Pick the exact day and time that suits you — the provider plans around it.", group: "Service Details", dependsOn: { field: "urgency", value: ["On a specific date & time"] } },
  { name: "budget_limit", label: "Budget (ZMW)", type: "currency", required: false, group: "Budget and Preferences" },
