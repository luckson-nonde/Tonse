...
interface OpenOptions {
  unread: number;
  /** User clicked "Open Tonse" in the widget — restore the app. */
  onRestore: () => void;
...
export async function openFloatingWindow(opts: OpenOptions): Promise<boolean> {
  ...
  nameWrap.appendChild(
    el('div', 'font-size:14px;font-weight:700;letter-spacing:.01em;', 'Tonse Hub')
  );
  nameWrap.appendChild(
