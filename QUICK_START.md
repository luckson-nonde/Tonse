...
> Get Nyuwe Zambia running locally in ~5 minutes (plus `npm install` time). Verified against the actual codebase on 2026-07-02. This merges the former `QUICK_START.md` + `QUICK_START_SETUP.md`.
