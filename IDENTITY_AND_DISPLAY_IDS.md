...
> **Single source of truth as of 2026-07-02.** This document replaces 8 fragmented, partially-stale docs (see "Superseded documents" below) with one canonical description of the Tonse Hub identity model and display-ID system, verified directly against the current codebase.
>
> Related docs:
